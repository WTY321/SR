...
#from Model.swin_transformer_v2 import *
...
class opts(object):
    def __init__(self):
        ...
        ##  path
        self.parser.add_argument('--root', type=str, default='/home/khuang@kean.edu/wty/CREAM/BAS/ILSVRC/NIH')
        self.parser.add_argument('--num_classes', type=int, default=8)
        self.parser.add_argument('--test_gt_path', type=str, default='/home/khuang@kean.edu/wty/CREAM/BAS/ILSVRC/NIH/test_gt.txt')
        self.parser.add_argument('--test_txt_path', type=str, default='/home/khuang@kean.edu/wty/CREAM/BAS/ILSVRC/NIH/test_list.txt')
        ##  save
        ...
        self.parser.add_argument('--resnet', default=True)
        ##  train
        self.parser.add_argument('--batch_size', type=int, default=60)
        self.parser.add_argument('--epochs', type=int, default=6)
        ...
        ##  model
        self.parser.add_argument('--arch', type=str, default='resnet')   ##  choose  [ vgg, resnet, inception, mobilenet ]
        ##  show
        self.parser.add_argument('--show_step', type=int, default=300)
        ##  GPU'
        self.parser.add_argument('--gpu', type=str, default='6')
...
if __name__ == '__main__':
    if args.phase == 'train':
        ...
        ##  model
        model=get_vmamba_model(8,pretrained=True).cuda()
        model.train()
        ##  optimizer 
        ...
        for epoch in range(0, args.epochs):
            ...
            poly_lr_scheduler(optimizer, epoch, decay_epoch=30)
            pr=1
            for step, (path,imgs, label) in enumerate(MyDataLoader):                
                ...
                if (step+1) % args.show_step == 0 :
                    print('  Epoch:[{}/{}]\t step:[{}/{}]\tcls_loss_1:{:.3f}\tcls_loss_2:{:.3f}\tbas_loss_2:{:.3f}\t cls_acc_1:{:.2f}%\tcls_acc_2:{:.2f}%'.format(
            ...
            if (epoch+1) % 10 == 0:
                torch.save(model.state_dict(), os.path.join('logs/NIH.pth.tar'),_use_new_zipfile_serialization=False)
